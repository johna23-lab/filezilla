...
#
# B21072022
# Added CFLAGS, CXXFLAGS and LDFLAGS this paramters "-static-libgcc -static-libstdc++"  
# to make more compatible with another distros
#
# B26062022
...
pushd $OUT
mkdir -p FileZilla_3.60.1.storj.x86_64.B21072022/bin

cp $OUT/lib/libuplink.so FileZilla_3.60.1.storj.x86_64B21072022/bin
strip bin/*
cp bin/filezilla FileZilla_3.60.1.storj.x86_64_B21072022/bin
cp bin/fz* FileZilla_3.60.1.storj.x86_64_B21072022/bin
cp bin/certtool FileZilla_3.60.1.storj.x86_64_B21072022/bin
cp -r share FileZilla_3.60.1.storj.x86_64_B21072022

echo '#!/bin/sh' > $OUT/FileZilla_3.60.1.storj.x86_64_B21072022/filezilla.sh
echo 'BIN=bin/./filezilla' >> $OUT/FileZilla_3.60.1.storj.x86_64_B21072022/filezilla.sh
echo 'export LD_LIBRARY_PATH=lib/x86_64-linux-gnu:/lib64:usr/lib/x86_64-linux-gnu/' >> $OUT/FileZilla_3.60.1.storj.x86_64_B21072022/filezilla.sh
echo 'exec $BIN $@' >> $OUT/FileZilla_3.60.1.storj.x86_64_B21072022/filezilla.sh
chmod a+x $OUT/FileZilla_3.60.1.storj.x86_64_B21072022/filezilla.sh
...
cp $OUT/lib/libuplink.so FileZilla_3.60.1.storj.x86_64_B21072022/lib/x86_64-linux-gnu/

mv $OUT/FileZilla_3.60.1.storj.x86_64_B21072022 ../FileZilla_3.60.1.storj.x86_64_B21072022_GLIBC_"$glibc"
popd
echo "FILEZILLA COMPILED AT $STAGING/FileZilla_3.60.1.storj.x86_64_B21072022_GLIBC_"$glibc""
